...
class Trainer:
    ...
    training_root_directory = "/Users/milesporter/data-science/data-sets/kaggle_speach_data"
    ...
    def train(self):
        ...
        x_train, y_train, x_test, y_test = train_test_split(X[0:1000], Y_vector[0:1000], test_size=0.1, random_state=42)
        ...
        model.fit(x=x_train, y=x_test, validation_data=(y_train, y_test),
